...
import { auth, createPaymentRequest, createUser, userChangePasswordSchema, userLoginSchema, validate } from "../../middlewares";
...
router.post("/request", auth, validate(createPaymentRequest), UserCtrl.createPaymentRequest);
