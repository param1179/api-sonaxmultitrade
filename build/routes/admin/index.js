...
router.post("/userRewards/:id", middlewares_1.authAdmin, (0, middlewares_1.validate)(middlewares_1.createUserRewards), controllers_1.AdminCtrl.createUserRewards);
router.get("/userRewards/:id", middlewares_1.authAdmin, controllers_1.AdminCtrl.getUserRewards);
...
router.delete("/reward/:id", middlewares_1.authAdmin, controllers_1.AdminCtrl.deleteReward);
