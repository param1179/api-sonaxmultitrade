...
var auth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, verifiedData, userId, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                token = (0, jwt_1.decode)(req);
                if (!token)
                    return [2 /*return*/, next(errors_1.ApiError.UnauthorizedError())];
                return [4 /*yield*/, (0, jwt_1.verifyToken)(token)];
            case 1:
                verifiedData = _a.sent();
                userId = verifiedData._id;
                return [4 /*yield*/, models_1.UserModel.findById(userId)];
            case 2:
                user = _a.sent();
                if (!user)
                    return [2 /*return*/, next(errors_1.ApiError.ForbiddenError())];
                req.userId = user._id;
                req.user = user;
                next();
                return [3 /*break*/, 4];
...
var authAdmin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, verifiedData, userId, admin, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
